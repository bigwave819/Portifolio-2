  ...
  return (
    <section id="skills">
      <div className="min-h-screen flex flex-col items-center text-center py-10 px-6 md:px-12 dark:bg-gray-950 dark:text-gray-200">
        <h1 className="text-3xl md:text-4xl font-bold mb-10" data-aos="fade-up">
          Skills
        </h1>
        <div
        ...
        >
          {skillsData.map((skill, index) => (
            <div
              key={index}
              className="bg-gray-200 dark:bg-gray-800 p-6 shadow-md rounded-lg"
            >
              <h2 className="text-xl font-bold mb-20" data-aos="fade-right">
                {skill.title}
              </h2>
              {skill.icon}
              <p className="text-gray-700 dark:text-gray-300 text-2xl mt-10 font-extralight">
                {skill.description}
              </p>
            </div>
          ))}
